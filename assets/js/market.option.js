...
"undefined" == typeof window.Shopify && (window.Shopify = {}),
    ...
    (Shopify.OptionSelectorsFromDOM.prototype.createProductFromSelector = function (t, n, a, s) {
        ...
        Shopify.each(o, function (t) {
            if (1 == t.nodeType && "option" == t.tagName.toLowerCase()) {
                ...
                var o = e.slice(0, p),
                    i = a ? e[p] : "",
                    r = (t.getAttribute("value"), { available: !t.disabled, id: parseFloat(t.value), price: i, option1: o[0], option2: o[1], option3: o[2] });
                l.push(r);
            }
        });
        var i = { variants: l };
