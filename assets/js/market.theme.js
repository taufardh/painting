...
slate.a11y = {
    ...
    trapFocus: function (options) {
        var eventName = options.eventNamespace ? "focusin." + options.eventNamespace : "focusin";
            ...
            avg: function (b) {
                ...
                if (!c._avg || b) {
                    var e,
                        ...
                        n = 0,
                        o = 0;
                    for (f = c.r1; f <= c.r2; f++) for (g = c.g1; g <= c.g2; g++) for (h = c.b1; h <= c.b2; h++) (j = a(f, g, h)), (e = d[j] || 0), (k += e), (m += e * (f + 0.5) * l), (n += e * (g + 0.5) * l), (o += e * (h + 0.5) * l);
        ...
        init: function (options) {
            ...
            return this.each(function (i) {
                ...
                origin.off("click.galleryExpand").on("click.galleryExpand", function (e) {
                    ...
                    var target = $(e.target);
                    if (target.attr("data-stop-propagation") || target.closest('[data-stop-propagation="true"]').length) {
                        return;
                    }
                    ...
                    // Card vars
                    var headerOffsetTop, newCardWidth, newCardHeight, cardWidthRatio, cardHeightRatio;
                    var recalculateVars = function () {
                        ...
                        bodyScrolls = bodyScrolls && (bodyStyle.overflow == "visible" || bodyStyle.overflowY == "visible" || bodyStyle.overflow == "auto" || bodyStyle.overflowY == "auto");
                    ...
                    overlay.off("click.galleryExpand").on("click.galleryExpand", function () {
                        returnToOriginal();
                    });
                    if (fillScreen) {
                        overlay
                    ...
                    if (typeof ColorThief !== "undefined" && $object.length) {
                        ...
                        try {
                            ...
                            if (tempCanvas.length) {
                                ...
                                if (tempCanvas[0].getContext("2d").canvas.width === imgWidth && tempCanvas[0].getContext("2d").canvas.height === imgHeight) {
                                    tempCanvas.remove();
                                }
                            }
                        }
                ...
                function returnToOriginal() {
                    ...
                    overlay.off("click.galleryExpand").off("mouseenter.galleryExpand").off("mouseleave.galleryExpand");
                    ...
                    $object.css("left", animationEndState.find(".gallery-cover").css("left")).removeClass("static hover");
                    resetSelectors();
                ...
                if (!dynamicRoutingChecked && dynamicRouting && urlObjectId === objectId) {
